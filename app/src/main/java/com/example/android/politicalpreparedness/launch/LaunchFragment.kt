...
class LaunchFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val binding = FragmentLaunchBinding.inflate(inflater).apply {
            lifecycleOwner = this@LaunchFragment
            upcomingElectionsButton.setOnClickListener { navToElections() }
            findRepresentativesButton.setOnClickListener { navToRepresentatives() }
        }
