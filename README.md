## Important Notes
You have to use your own Google Civic API key. Please replace string ``def GOOGLE_API_KEY = "PUT_YOUR_API_KEY_HERE"`` in ~/app/build.gradle file with your API key.

Folder ~/apk contains the signed apk file.
